...
- 🤖 **Multi-Agent AI Systems** using Google ADK and OpenAI
- 🐍 **Python** backend development (FastAPI, asyncio, async/await)
- ⚛️ **Full-Stack Development** (React, TypeScript, Node.js)
- ☁️ **Cloud Architecture** (Google Cloud Platform, Vertex AI)
- 🔄 **Real-time Systems** (Server-Sent Events, WebSockets, streaming)
...
![Cohere](https://img.shields.io/badge/Cohere-FF6D5A?style=for-the-badge&logo=cohere&logoColor=white)
![BERT](https://img.shields.io/badge/BERT-FF6F00?style=for-the-badge&logo=google&logoColor=white)
![Whisper](https://img.shields.io/badge/Whisper-00A8E8?style=for-the-badge&logo=openai&logoColor=white)
...
<details>
<summary><b>View my contributions</b></summary>

#### 🐛 Bug Fixes & Improvements
- [#3745](https://github.com/google/adk-python/pull/3745) - Allow app_name to override App.name in Runner initialization
- [#3576](https://github.com/google/adk-python/pull/3576) - Fix/add validation for unique sub-agent names
- [#3734](https://github.com/google/adk-python/pull/3734) - Enhanced Artifact Management in Google’s ADK-Python
...
- ✍️ [Medium](https://medium.com/@sarojkumar.rout) - Read my articles on AI, Multi-Agent Systems, and Software Engineering
